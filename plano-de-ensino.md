...
## Introdução
A disciplina de Controle Inteligente é uma oportunidade única para os alunos se aprofundarem na interseção entre Inteligência Artificial e diversas áreas da Engenharia Elétrica.
